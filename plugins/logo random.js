...
if (!args[0]) throw '*[❗] Ingrese un texto*\n*Ejemplo:*\n*#logorandom 𝐇𝐚𝐝𝐞𝐬_𝐛𝐨𝐭*'        
let res = `https://api-alc.herokuapp.com/api/photooxy/${pickRandom(global.logos)}?texto=${response[0]}&apikey=ConfuMods`
conn.sendButtonImg(m.chat, res, "*Logo random terminado*", '❍͜͡➣𝐇𝐚𝐝𝐞𝐬_𝐛𝐨𝐭❍͜͡➣', 'SIGUIENTE', `${usedPrefix + command} ${text}`, m, false, { contextInfo: { mentionedJid }})}
