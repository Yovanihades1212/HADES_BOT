...
conn.sendButton(m.chat, `*Hola, como te puedo ayudar?*`, '❍͜͡➣𝐇𝐀𝐃𝐄𝐒_𝐁𝐎𝐓❍͜͡➣ᰰ', '❍͜͡➣️𝙼𝙴𝙽𝚄 𝙳𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾𝚂❍͜͡➣', `${usedPrefix}menu`, 'conversation', { sendEphemeral: true, quoted: estilo })
